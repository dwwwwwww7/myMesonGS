...
def compress_gpcc(x: torch.Tensor, gpcc_codec_path=r"C:\Users\LENOVO\Desktop\PCS25RAHT\tmc3\tmc3.exe") -> bytes:
    """
    Compress geometry point cloud by GPCC codec.
    """
...
def decompress_gpcc(strings: bytes, gpcc_codec_path = r"C:\Users\LENOVO\Desktop\PCS25RAHT\tmc3\tmc3.exe") -> torch.Tensor:
    """
    Decompress geometry point cloud by GPCC codec.
    """
    with TemporaryDirectory() as temp_dir:
